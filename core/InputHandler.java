...
public class InputHandler implements KeyListener {
    ...
    public void keyPressed(KeyEvent e) {
        ...
        // Only register a "this frame" press on the INITIAL key-down.
        // The OS fires repeated keyPressed events while a key is held
        // (auto-repeat); ignoring them keeps one-shot actions (jump,
        // menu select, etc.) firing exactly once per physical press.
        if (!pressedKeys.contains(code)) {
            keysThisFrame.add(code);
        }
