...
public class GamePanel extends JPanel {
    ...
    protected void paintComponent(Graphics g) {
        ...
        } else if (currentState.equals(GameStateManager.PAUSED)) {
            drawPauseScreen(g);
    ...
    /**
     * Draw the pause screen: the current minigame frozen in the background
     * with the pause menu overlay on top.
     * @param g Graphics object
     */
    private void drawPauseScreen(Graphics g) {
        ...
        // Draw semi-transparent overlay with pause options
        uiManager.drawPauseMenu(g);
    }
    ...
    private void updateResultsState() {
        if (inputHandler.isKeyPressedThisFrame(KeyEvent.VK_R)) {
            // Replay the current minigame and undo the just-awarded round score
